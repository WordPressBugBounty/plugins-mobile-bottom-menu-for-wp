...
Do you want more features for your WordPress Mobile Bottom menu? Upgrade to the pro version of the “WP Mobile Bottom Menu” plugin and unlock a world of advanced features.
...
There is no prerequisites for installing **WP Mobile Bottom Menu**. You can follow the steps below to complete the installation.

= Automatic Installation =
1.  Go to `Plugins > Add New` screen from your WordPress website dashboard.
2.  Search for `WP Mobile Bottom Menu`.
